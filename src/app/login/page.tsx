            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    <div className="space-y-6">
                        ...
                        <div className="text-center"><a href="#" className="text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors">{t('login.forgotPassword')}</a></div>
                    </div>
                </div>
