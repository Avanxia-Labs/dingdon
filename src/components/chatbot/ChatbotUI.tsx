...
//   const { messages, isOpen, isLoading, toggleChat, sendMessage, status, startNewChat, config, error } = useChatbot();
...
//       {/* Chat Panel */}
//       <div className={`fixed bottom-24 h-full w-full right-6 z-[999] w-full max-w-sm h-[70vh] max-h-[500px] bg-white rounded-lg shadow-2xl flex flex-col transition-all duration-300 ease-in-out ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
//         {/* Header */}
//         <div
...
//                     {/* Nota para mensajes del bot */}
//                     {message.role === 'assistant' && (
//                       <div className="mt-5 text-xs text-gray-500 mt-2 pt-1 border-t border-gray-200">
