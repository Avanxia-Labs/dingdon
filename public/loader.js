// // public/loader.js
// (function() {
//     // Función para asegurar que el script se ejecuta solo una vez
...
//     if (!workspaceId) {
//         console.error("Chatbot: 'data-workspace-id' attribute is missing from script tag.");
//         return;
//     }
...
//     iframe.style.width = 'calc(100% - 40px)'; // Ancho responsivo
//     iframe.style.height = 'calc(100% - 40px)'; // Alto responsivo
//     iframe.style.maxWidth = '500px';
//     iframe.style.maxHeight = '90vh';
//     iframe.style.border = 'none';
//     iframe.style.zIndex = '2147483647'; // Un z-index muy alto
